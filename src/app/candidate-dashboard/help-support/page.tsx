      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="relative overflow-hidden rounded-xl border border-border bg-card dark:border-white/10 dark:bg-[#0b1329]/40 dark:backdrop-blur-md shadow-lg p-6">
          ...
          <CardContent className="p-0 pt-6">
            ...
            >
              <Button className="w-full h-10 rounded-lg border-white/15 bg-white/[0.02] text-xs font-semibold text-slate-300 hover:bg-white/[0.06] hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none" variant="outline">
                Send Message
              </Button>
            </ContactFormDialog>
          </CardContent>
