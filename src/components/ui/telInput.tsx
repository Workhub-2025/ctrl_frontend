    ...
    return (
      <div className={cn("space-y-2", className)}>
        <div className="relative">
          <input
            className={cn(
              "flex h-10 w-full rounded-xl border border-border/70 dark:border-white/10 bg-background/50 dark:bg-black/20 px-12 py-2 text-base ring-offset-background",
