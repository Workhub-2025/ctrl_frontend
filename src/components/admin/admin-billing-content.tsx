          ...
          <AdminPanel className="space-y-6">
            <div className="flex items-start gap-3 border-b border-border/50 pb-4">
              ...
              <AdminSectionHeader
                ...
                description="Catalogue rates for new activations and unlocked renewals. Once a client pays, their contract locks the annual platform fee (Founder: 3 years; Essential/Professional: current term). Mid-term catalogue increases do not change that locked plan."
              />
            </div>
