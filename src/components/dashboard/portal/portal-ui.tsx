...
export type PortalPanelAccent = string;

export function PortalNavCard(props: {
  href: string;
  icon: LucideIcon;
  title: string;
  description: string;
  ...
  return (
    <Link href={props.href} className="group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-xl">
      <PortalLinkCard
        href={props.href}
        icon={props.icon}
        title={props.title}
