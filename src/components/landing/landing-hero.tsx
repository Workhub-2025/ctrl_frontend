    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6" style={{ paddingTop: navHeight }}>
        <div className="flex flex-col items-center text-center max-w-[56rem] mx-auto gap-8">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 dark:border-white/5 bg-slate-100 dark:bg-white/5 px-3.5 py-1.5 text-[11px] font-mono tracking-wider text-slate-500 dark:text-slate-400 backdrop-blur-sm pointer-events-none">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight text-white leading-[1.08] font-display text-balance">
          ...
          >
            <Button
              asChild
              className="h-12 md:h-14 rounded-full bg-white px-8 text-black hover:bg-slate-200 transition-colors text-sm md:text-base font-medium w-full sm:w-auto focus-visible:ring-2 focus-visible:ring-white/50"
            >
            ...
            <Button
              ...
              className="h-12 md:h-14 rounded-full border border-white/10 dark:border-white/5 bg-transparent px-8 text-slate-300 hover:bg-white/5 hover:text-white transition-colors text-sm md:text-base font-medium w-full sm:w-auto focus-visible:ring-2 focus-visible:ring-white/20"
            >
              Explore Platform
            </Button>
          </motion.div>
          ...
          <motion.div
            ...
            className="w-full max-w-lg mt-8 relative rounded-2xl border border-white/10 bg-[#0a0a0a] overflow-hidden shadow-2xl p-4 flex flex-col gap-3 font-mono text-xs text-left select-none telemetry-grid"
          >
            ...
            <div className="w-full h-12 rounded-lg border border-white/5 bg-[#050505] overflow-hidden relative flex items-center justify-center p-2">
              ...
              <div className="flex items-center gap-1.5 w-full justify-center relative z-10">
                {[16, 28, 18, 38, 22, 32, 14, 30, 20, 34, 15, 26, 12, 22, 30, 42, 28, 48, 16, 33, 49, 12, 24, 38].map((peak, i) => (
                  <motion.div
                    key={i}
                    className="w-1 bg-white/40 dark:bg-white/30 rounded-full"
                    style={{ height: "10px" }}
